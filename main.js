$(document).ready(function () {
  ...
  function gameMenu() {
    ...
    $(
      "#message"
    ).html(`Do your best to match all the cards as fast as you can.</br>
        ...
        if (firstVal === secondVal) {
          ...
          function match() {
            setTimeout(() => {
              $("#message")
                .slideDown("slow")
                .html("Good job! Keep up the good work!");
              points++;
            ...
            function win() {
              ...
              if (minutes >= 1) {
                $("#points")
                  .slideDown("slow")
                  .html(
                    "You need to be faster... because you took more than 1 minute, you get one point taken away... you have just 9 points. Better luck next time."
                  );
              } else {
                $("#points").slideUp("slow");
              }
              ...
              $("#attempts")
                ...
                .html(
                  `You took ${
                    30 - attempts
                  } attempts with ${totalTries} total tries to finish the game. you can do better.`
                );
              clearInterval(timer);
              $(".resultTime")
                .slideDown("slow")
                .html(
                  `you finished the game in ${minutes} minutes and ${seconds} seconds. Good Job.`
                );
            }
          }
          ...
          function noMatch() {
            setTimeout(() => {
              ...
              $("#attempts")
                .slideDown("slow")
                .html(`you have ${attempts} attemps left...`);
